...
//		
//		// 포매터 객체 생성(입력용)
//		DateTimeFormatter fmtin = DateTimeFormatter.ofPattern("yyyy/MM/dd");	// 로컬데이트타임용 포매터
...
//		System.out.println("출력 포맷: " + fmtout.format(date));
		...
		// 포매터 객체 생성(입력용)
		DateTimeFormatter fmtin = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");	// 로컬데이트타임용 포매터
