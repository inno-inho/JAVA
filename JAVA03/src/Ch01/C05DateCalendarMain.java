...
public class C05DateCalendarMain {
	...
	public static void main(String[] args) {
		// Date
//		Date d1 = new Date();
//		System.out.println(d1);	// Fri Aug 22 10:34:28 GMT+09:00 2025 -> 현재 날짜 정보 출력됌
...
//		System.out.println(d1.getTime());	// 타임스탬프(HH:mm:ss)	-> 1755826597107
...
//		System.out.println(cal.get(Calendar.SECOND));
		...
		DayOfWeek dayOfWeek = now.getDayOfWeek();		// 요일에 대한 문자열 값
